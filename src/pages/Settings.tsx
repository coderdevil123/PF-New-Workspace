        ...
        <div className="mx-auto max-w-4xl space-y-8">
          ...
          <div className="rounded-2xl border border-border bg-white dark:bg-dark-card p-8 shadow-card animate-slide-up">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-xl font-normal text-heading-dark dark:text-dark-text">Notifications</h3>
                <p className="font-sans text-sm text-body-text dark:text-dark-muted">Manage how you receive notifications</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                { key: 'marketing', label: 'Marketing Updates', description: 'Product updates and newsletters' },
              ].map((item) => (
          ...
          <div className="rounded-2xl border border-border bg-white dark:bg-dark-card p-8 shadow-card animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-xl font-normal text-heading-dark dark:text-dark-text">Privacy & Security</h3>
                <p className="font-sans text-sm text-body-text dark:text-dark-muted">Control your privacy and security settings</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-border bg-light-gray dark:bg-dark-hover p-4">
                <div className="mb-3">
                  <p className="font-medium text-heading-dark dark:text-dark-text">Profile Visibility</p>
                  <p className="text-sm text-body-text dark:text-dark-muted">Who can see your profile information</p>
                </div>
                <select
                ...
                >
                  <option value="public" className="bg-white dark:bg-dark-card text-heading-dark dark:text-dark-text">Everyone</option>
                  <option value="team" className="bg-white dark:bg-dark-card text-heading-dark dark:text-dark-text">Team Members Only</option>
                  <option value="private" className="bg-white dark:bg-dark-card text-heading-dark dark:text-dark-text">Private</option>
                </select>
              </div>

              {[
                { key: 'activityStatus', label: 'Show Activity Status', description: 'Let others see when you\'re online' },
                { key: 'dataSharing', label: 'Analytics Data Sharing', description: 'Help improve our services' },
              ].map((item) => (
                <div key={item.key} className="flex items-center justify-between rounded-lg border border-border bg-light-gray dark:bg-dark-hover p-4">
                  <div>
                    <p className="font-ui font-medium text-heading-dark dark:text-dark-text">{item.label}</p>
